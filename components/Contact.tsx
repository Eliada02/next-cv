...
const Contact: React.FC<ContactProps> = ({ isDarkMode }) => {
  ...
  const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append("access_key", "2192efa2-e05e-442e-8315-8a6ae872b03a");
  ...
  return (
    <div id="contact" className="w-full px-[12%] py-10 scroll-mt-20 bg-[url('/footer-bg-color.png')] bg-no-repeat bg-center bg-[length:90%_auto]">
      ...
      <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
       📩 Have a question, a project idea, or just want to say hello? Feel free to reach out using 
      ...
      <form onSubmit={onSubmit} className='max-w-2xl mx-auto' >
        ...
        bg-black/80  text-white rounded-full mx-auto hover:bg-black duration-500'>Submit Now <Image src={assets.right_arrow_white} alt='submit btn' className='w-4'/> </button>
